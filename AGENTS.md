...
- **Foco após overlay**: se o gatilho some (item de menu Editar), restaurar para o ⋮ estável (`data-news-more`) ou Nova notícia. `markTrigger` nesse botão. Hash de `useRestoreFocus` não muda. Teste de foco sem Playwright `force`.
...
- `src/components/news/AGENTS.md` — editor fullscreen: foco volta ao ⋮ (`data-news-more`)

...
- `npx tsx --test src/lib/e-social/ts-nome.test.ts src/lib/e-social/esocialAutoCorrector.test.ts src/lib/e-social/esocial-date.test.ts src/lib/e-social/xml-linear.test.ts`

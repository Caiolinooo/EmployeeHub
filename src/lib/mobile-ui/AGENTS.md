...
- Fallback P0: `next.config.js` `rewrites.beforeFiles` (`/login` + cookie/CH/UA; `/m/preview` 404 em produção)
...
- `npx tsx --test src/lib/mobile-ui/device-surface.test.ts src/lib/mobile-ui/preview-block.test.ts`

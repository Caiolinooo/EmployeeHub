...
- **XLSX**: `GET /relatorio-mensal?download=true` aceita `embarcacoes` (vírgula) além de `embarcacao`; filename reflete multi-embarcações + período (`montarNomeArquivoFechamento`).

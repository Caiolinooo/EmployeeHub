...
export async function POST(request: NextRequest) {
  try {
    ...
    const registro = {
      ...
      pais: (texto(body.pais) || 'BR').toUpperCase(),
      tax_id: texto(body.tax_id) || null,
      inscricao_municipal: texto(body.inscricao_municipal) || null,
      inscricao_estadual: texto(body.inscricao_estadual) || null,
      default_template_id: texto(body.default_template_id) || null,

...
export const SYSTEM_MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    features: [
      ...
      feat('gestao-tripulantes.fechamento.marcas', 'Marcar colaboradores no fechamento', 'Marca colaboradores na lista do fechamento mensal', STAFF),
      feat('gestao-tripulantes.fechamento.revisao', 'Revisar edições da escala', 'Rejeita ou reverte edições auditadas da escala', STAFF),
